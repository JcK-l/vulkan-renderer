...
\label{md_updates_2_november__6_autotoc_md7}%
\Hypertarget{md_updates_2_november__6_autotoc_md7}%
...
In the following sections I\textquotesingle{}ll talk about some of the things that I\textquotesingle{}ve implemented.\hypertarget{md_updates_2_november__6_autotoc_md8}{}\doxysubsection{\texorpdfstring{Application}{Application}}\label{md_updates_2_november__6_autotoc_md8}
...
This simple system will probably work fine for everything we need. In the future we might need to forward the events to the gui, but that can just be a method call from a gui class.\hypertarget{md_updates_2_november__6_autotoc_md9}{}\doxysubsection{\texorpdfstring{Window}{Window}}\label{md_updates_2_november__6_autotoc_md9}
...
It uses glfw\+Get\+Window\+User\+Pointer to get the window\+Data and then uses the callback which gets set in the application.\hypertarget{md_updates_2_november__6_autotoc_md10}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_updates_2_november__6_autotoc_md10}
...
The type can then be checked in switch statement and the data can be accessed.\hypertarget{md_updates_2_november__6_autotoc_md11}{}\doxysubsection{\texorpdfstring{Input Polling}{Input Polling}}\label{md_updates_2_november__6_autotoc_md11}
...
\end{DoxyCode}
\hypertarget{md_updates_2_november__6_autotoc_md12}{}\doxysubsection{\texorpdfstring{Logging}{Logging}}\label{md_updates_2_november__6_autotoc_md12}
...
\end{DoxyCode}
\hypertarget{md_updates_2_november__6_autotoc_md13}{}\doxysubsection{\texorpdfstring{Vulkan Hpp}{Vulkan Hpp}}\label{md_updates_2_november__6_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md_updates_2_november__6_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{Dynamic Loader}{Dynamic Loader}}\label{md_updates_2_november__6_autotoc_md14}
...
There is a detailed explanation in the \href{https://github.com/KhronosGroup/Vulkan-Hpp}{\texttt{ vulkan.\+hpp}} git\+Hub \doxylink{_r_e_a_d_m_e_8md}{README.\+md}.\hypertarget{md_updates_2_november__6_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{Raii}{Raii}}\label{md_updates_2_november__6_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md_updates_2_november__6_autotoc_md17}{}\doxysubsection{\texorpdfstring{Results}{Results}}\label{md_updates_2_november__6_autotoc_md17}
