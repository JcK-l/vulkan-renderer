...
\hypertarget{md_updates_24___november__06}{}\label{md_updates_24___november__06}\index{November 06 -\/ First Commit@{November 06 -\/ First Commit}}
\label{md_updates_24___november__06_autotoc_md9}%
\Hypertarget{md_updates_24___november__06_autotoc_md9}%
...
In the following sections I\textquotesingle{}ll talk about some of the things that I\textquotesingle{}ve implemented.\hypertarget{md_updates_24___november__06_autotoc_md10}{}\doxysubsection{\texorpdfstring{Application}{Application}}\label{md_updates_24___november__06_autotoc_md10}
...
This simple system will probably work fine for everything we need. In the future we might need to forward the events to the gui, but that can just be a method call from a gui class.\hypertarget{md_updates_24___november__06_autotoc_md11}{}\doxysubsection{\texorpdfstring{Window}{Window}}\label{md_updates_24___november__06_autotoc_md11}
...
It uses glfw\+Get\+Window\+User\+Pointer to get the window\+Data and then uses the callback which gets set in the application.\hypertarget{md_updates_24___november__06_autotoc_md12}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_updates_24___november__06_autotoc_md12}
...
The type can then be checked in switch statement and the data can be accessed.\hypertarget{md_updates_24___november__06_autotoc_md13}{}\doxysubsection{\texorpdfstring{Input Polling}{Input Polling}}\label{md_updates_24___november__06_autotoc_md13}
...
\end{DoxyCode}
\hypertarget{md_updates_24___november__06_autotoc_md14}{}\doxysubsection{\texorpdfstring{Logging}{Logging}}\label{md_updates_24___november__06_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md_updates_24___november__06_autotoc_md15}{}\doxysubsection{\texorpdfstring{Vulkan Hpp}{Vulkan Hpp}}\label{md_updates_24___november__06_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md_updates_24___november__06_autotoc_md16}{}\doxysubsubsection{\texorpdfstring{Dynamic Loader}{Dynamic Loader}}\label{md_updates_24___november__06_autotoc_md16}
...
There is a detailed explanation in the \href{https://github.com/KhronosGroup/Vulkan-Hpp}{\texttt{ vulkan.\+hpp}} git\+Hub README.\+md.\hypertarget{md_updates_24___november__06_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{Raii}{Raii}}\label{md_updates_24___november__06_autotoc_md17}
...
TODO\+: write about enabling layers and extensions\hypertarget{md_updates_24___november__06_autotoc_md19}{}\doxysubsection{\texorpdfstring{Debug Messenger}{Debug Messenger}}\label{md_updates_24___november__06_autotoc_md19}
...
\end{DoxyCode}
\hypertarget{md_updates_24___november__06_autotoc_md20}{}\doxysubsection{\texorpdfstring{Results}{Results}}\label{md_updates_24___november__06_autotoc_md20}
