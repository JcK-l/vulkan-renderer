...
\hypertarget{md_updates_22__11__12}{}\label{md_updates_22__11__12}\index{November 12 -\/ Vulkan Setup@{November 12 -\/ Vulkan Setup}}
\label{md_updates_22__11__12_autotoc_md12}%
\Hypertarget{md_updates_22__11__12_autotoc_md12}%
 This update sets up basic Physical device selction and Logical device creation. All this functionality is needed for future updates.\hypertarget{md_updates_22__11__12_autotoc_md13}{}\doxysubsection{\texorpdfstring{Physical Device}{Physical Device}}\label{md_updates_22__11__12_autotoc_md13}
The Physical device is the GPU that will be used for rendering. It is selected in the {\ttfamily Instance} class.\hypertarget{md_updates_22__11__12_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{Physical Device Selection}{Physical Device Selection}}\label{md_updates_22__11__12_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md_updates_22__11__12_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{Physical Device Features}{Physical Device Features}}\label{md_updates_22__11__12_autotoc_md15}
...
\end{DoxyCode}
\hypertarget{md_updates_22__11__12_autotoc_md16}{}\doxysubsection{\texorpdfstring{Logical Device}{Logical Device}}\label{md_updates_22__11__12_autotoc_md16}
The Logical device is the interface with the GPU therefore it gets used for almost everything. Device extensions get enabled like they do in the {\ttfamily Instance} class.\hypertarget{md_updates_22__11__12_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{Queues}{Queues}}\label{md_updates_22__11__12_autotoc_md17}
...
The Device supports different ways to get a queue. The first uses the queue index and family index. If the need for a queue with a specific flag arises, the second function can be used. The third function returns a queue that supports presenting to a window surface. Exclude flags can also be specified. The last three functions query instead of returning a Queue.\hypertarget{md_updates_22__11__12_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{Vma\+Allocator}{VmaAllocator}}\label{md_updates_22__11__12_autotoc_md18}
