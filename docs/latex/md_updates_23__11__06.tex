...
\hypertarget{md_updates_23__11__06}{}\label{md_updates_23__11__06}\index{November 06 -\/ First Commit@{November 06 -\/ First Commit}}
\label{md_updates_23__11__06_autotoc_md19}%
\Hypertarget{md_updates_23__11__06_autotoc_md19}%
...
In the following sections I\textquotesingle{}ll talk about some of the things that I\textquotesingle{}ve implemented.\hypertarget{md_updates_23__11__06_autotoc_md20}{}\doxysubsection{\texorpdfstring{Application}{Application}}\label{md_updates_23__11__06_autotoc_md20}
...
This simple system will probably work fine for everything we need. In the future we might need to forward the events to the gui, but that can just be a method call from a gui class.\hypertarget{md_updates_23__11__06_autotoc_md21}{}\doxysubsection{\texorpdfstring{Window}{Window}}\label{md_updates_23__11__06_autotoc_md21}
...
It uses glfw\+Get\+Window\+User\+Pointer to get the window\+Data and then uses the callback which gets set in the application.\hypertarget{md_updates_23__11__06_autotoc_md22}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_updates_23__11__06_autotoc_md22}
...
The type can then be checked in switch statement and the data can be accessed.\hypertarget{md_updates_23__11__06_autotoc_md23}{}\doxysubsection{\texorpdfstring{Input Polling}{Input Polling}}\label{md_updates_23__11__06_autotoc_md23}
...
\end{DoxyCode}
\hypertarget{md_updates_23__11__06_autotoc_md24}{}\doxysubsection{\texorpdfstring{Logging}{Logging}}\label{md_updates_23__11__06_autotoc_md24}
...
\end{DoxyCode}
\hypertarget{md_updates_23__11__06_autotoc_md25}{}\doxysubsection{\texorpdfstring{Vulkan Hpp}{Vulkan Hpp}}\label{md_updates_23__11__06_autotoc_md25}
...
\end{DoxyCode}
\hypertarget{md_updates_23__11__06_autotoc_md26}{}\doxysubsubsection{\texorpdfstring{Dynamic Loader}{Dynamic Loader}}\label{md_updates_23__11__06_autotoc_md26}
...
There is a detailed explanation in the \href{https://github.com/KhronosGroup/Vulkan-Hpp}{\texttt{ vulkan.\+hpp}} git\+Hub README.\+md.\hypertarget{md_updates_23__11__06_autotoc_md27}{}\doxysubsubsection{\texorpdfstring{Raii}{Raii}}\label{md_updates_23__11__06_autotoc_md27}
...
It tries to enable all the extensions that were passed as required extensions in the constructor and throws an error if one of them is not available.\hypertarget{md_updates_23__11__06_autotoc_md29}{}\doxysubsection{\texorpdfstring{Debug Messenger}{Debug Messenger}}\label{md_updates_23__11__06_autotoc_md29}
...
\end{DoxyCode}
\hypertarget{md_updates_23__11__06_autotoc_md30}{}\doxysubsection{\texorpdfstring{Results}{Results}}\label{md_updates_23__11__06_autotoc_md30}
