...
\hypertarget{md_updates_21__11__25}{}\label{md_updates_21__11__25}\index{November 25 -\/ RenderManger@{November 25 -\/ RenderManger}}
\label{md_updates_21__11__25_autotoc_md1}%
\Hypertarget{md_updates_21__11__25_autotoc_md1}%
 In this update I will be going over the new {\ttfamily Render\+Manager} class and how it is used to manage the rendering of the application.\hypertarget{md_updates_21__11__25_autotoc_md2}{}\doxysubsection{\texorpdfstring{Swapchain}{Swapchain}}\label{md_updates_21__11__25_autotoc_md2}
...
The {\ttfamily create\+Swapchain} method can take an optional {\ttfamily old\+Swapchain} parameter, which is used when recreating the swapchain.\hypertarget{md_updates_21__11__25_autotoc_md3}{}\doxysubsection{\texorpdfstring{Frame\+Data}{FrameData}}\label{md_updates_21__11__25_autotoc_md3}
...
These then get used in the {\ttfamily Render\+Manager} class to get the necessary data for the current frame.\hypertarget{md_updates_21__11__25_autotoc_md4}{}\doxysubsubsection{\texorpdfstring{Command\+Pool}{CommandPool}}\label{md_updates_21__11__25_autotoc_md4}
...
The unordered map might not be the best solution, but it works for now.\hypertarget{md_updates_21__11__25_autotoc_md5}{}\doxysubsection{\texorpdfstring{Framebuffer}{Framebuffer}}\label{md_updates_21__11__25_autotoc_md5}
...
The vk\+::raii\+::\+Framebuffer only accepts an array of vk\+::\+Image\+Views, so the vk\+::raii\+::\+Image\+Views need to be converted to vk\+::\+Image\+Views.\hypertarget{md_updates_21__11__25_autotoc_md6}{}\doxysubsection{\texorpdfstring{Renderer}{Renderer}}\label{md_updates_21__11__25_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_updates_21__11__25_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{Render\+Pass}{RenderPass}}\label{md_updates_21__11__25_autotoc_md7}
...
The {\ttfamily Render\+Pass} class receives all the necessary create info from the {\ttfamily Renderer} class. This includes descriptions of all attachments that will be used, the subpass descriptions and the subpass dependencies.\hypertarget{md_updates_21__11__25_autotoc_md8}{}\doxysubsubsection{\texorpdfstring{Render\+Target}{RenderTarget}}\label{md_updates_21__11__25_autotoc_md8}
...
This information gets used when creating the {\ttfamily Framebuffer} and {\ttfamily Render\+Pass}.\hypertarget{md_updates_21__11__25_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{Render\+Substage}{RenderSubstage}}\label{md_updates_21__11__25_autotoc_md9}
The Render\+Substage is not doing anything at the moment. It represents a subpass that needs to be drawn. When the {\ttfamily draw} method of the {\ttfamily Renderer} is called, it will iterate over all the {\ttfamily Render\+Substages} and call their {\ttfamily draw} in turn.\hypertarget{md_updates_21__11__25_autotoc_md10}{}\doxysubsection{\texorpdfstring{Render loop}{Render loop}}\label{md_updates_21__11__25_autotoc_md10}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ LOG\_DEBUG("{}Acquired\ next\ image:\ \{\}"{},\ value)}}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ .pCommandBuffers\ =\ \&*(*activeCommandBuffer),\ \textcolor{comment}{//\ What\ the\ hell}}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ vk::Result::eSuccess:}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ \ \ \ LOG\_DEBUG("{}Presented\ image:\ \{\}"{},\ value)}}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{break};}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ vk::Result::eSuboptimalKHR:}
...
In {\ttfamily draw} the scene will be drawn. This will be done in the next update.\hypertarget{md_updates_21__11__25_autotoc_md11}{}\doxysubsection{\texorpdfstring{Results}{Results}}\label{md_updates_21__11__25_autotoc_md11}
