...
void calculateRayBasis(in vec3 prevPos, in vec3 nextPos, in vec3 prevBinormal, out vec3 normal, out vec3 binormal);
...
void main()
{
    ...
    TubeGeometryInfo endInfo = TubeGeometryInfo(nextPos, normal, binormal, tangent, tubeRadius, 0);
