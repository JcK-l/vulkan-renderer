...
\label{md_updates_24__11__06_autotoc_md22}%
\Hypertarget{md_updates_24__11__06_autotoc_md22}%
...
In the following sections I\textquotesingle{}ll talk about some of the things that I\textquotesingle{}ve implemented.\hypertarget{md_updates_24__11__06_autotoc_md23}{}\doxysubsection{\texorpdfstring{Application}{Application}}\label{md_updates_24__11__06_autotoc_md23}
...
This simple system will probably work fine for everything we need. In the future we might need to forward the events to the gui, but that can just be a method call from a gui class.\hypertarget{md_updates_24__11__06_autotoc_md24}{}\doxysubsection{\texorpdfstring{Window}{Window}}\label{md_updates_24__11__06_autotoc_md24}
...
It uses glfw\+Get\+Window\+User\+Pointer to get the window\+Data and then uses the callback which gets set in the application.\hypertarget{md_updates_24__11__06_autotoc_md25}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{md_updates_24__11__06_autotoc_md25}
...
The type can then be checked in switch statement and the data can be accessed.\hypertarget{md_updates_24__11__06_autotoc_md26}{}\doxysubsection{\texorpdfstring{Input Polling}{Input Polling}}\label{md_updates_24__11__06_autotoc_md26}
...
\end{DoxyCode}
\hypertarget{md_updates_24__11__06_autotoc_md27}{}\doxysubsection{\texorpdfstring{Logging}{Logging}}\label{md_updates_24__11__06_autotoc_md27}
...
\end{DoxyCode}
\hypertarget{md_updates_24__11__06_autotoc_md28}{}\doxysubsection{\texorpdfstring{Vulkan Hpp}{Vulkan Hpp}}\label{md_updates_24__11__06_autotoc_md28}
...
\end{DoxyCode}
\hypertarget{md_updates_24__11__06_autotoc_md29}{}\doxysubsubsection{\texorpdfstring{Dynamic Loader}{Dynamic Loader}}\label{md_updates_24__11__06_autotoc_md29}
...
There is a detailed explanation in the \href{https://github.com/KhronosGroup/Vulkan-Hpp}{\texttt{ vulkan.\+hpp}} git\+Hub README.\+md.\hypertarget{md_updates_24__11__06_autotoc_md30}{}\doxysubsubsection{\texorpdfstring{Raii}{Raii}}\label{md_updates_24__11__06_autotoc_md30}
...
TODO\+: write about enabling layers and extensions\hypertarget{md_updates_24__11__06_autotoc_md32}{}\doxysubsection{\texorpdfstring{Debug Messenger}{Debug Messenger}}\label{md_updates_24__11__06_autotoc_md32}
...
\end{DoxyCode}
\hypertarget{md_updates_24__11__06_autotoc_md33}{}\doxysubsection{\texorpdfstring{Results}{Results}}\label{md_updates_24__11__06_autotoc_md33}
